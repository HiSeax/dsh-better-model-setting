window.__ModuleLoader__.load({
	id: "@dsh-external/dsh-better-model-setting",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		function BetterModelSettingPanel(props) {
			...
			const renderProviderRow = (row, index) => {
				...
				return react.default.createElement("li", {
					...
					react.default.createElement("div", {
						...
						className: "bms-editorTitle",
						key: "et"
					}, text("editProvider").replace("{provider}", row.displayName)), react.default.createElement("span", {
						className: "bms-editorRoute",
						key: "er"
					}, provider)]),
					(() => {
								...
								react.default.createElement("div", { className: "bms-modelList" }, row.models.map((model) => {
									...
									return react.default.createElement("div", {
										...
										react.default.createElement("label", {
											...
											key: "",
											value: ""
										}, text("defaultTier", "默认")), ...whitelist.map((tier) => react.default.createElement("option", {
											key: tier,
											value: tier
										}, tier))])]),
										react.default.createElement("label", {
			...
			return react.default.createElement("div", { className: "better-model-setting bms-section" }, [
				...
				!officialAdded ? react.default.createElement("div", {
					key: "officialActions",
					style: {
						display: "flex",
